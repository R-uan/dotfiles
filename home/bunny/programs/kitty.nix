{
  ...
  programs.kitty = {
    ...
    settings = {
      ...
      selection_foreground      = "#131714"; # background0
      selection_background      = "#83977f"; # colour4 / primary0
      cursor                    = "#c2d4bc"; # colour7
      cursor_text_color         = "#131714"; # background0
      ...
      wayland_titlebar_color    = "#131714"; # background0
      macos_titlebar_color      = "#1c231e"; # background1

      active_tab_foreground     = "#131714"; # background0
      ...
      tab_bar_background        = "#131714"; # background0

      mark1_foreground          = "#131714"; # background0
      mark1_background          = "#83977f"; # colour4 / primary0
      mark2_foreground          = "#131714"; # background0
      mark2_background          = "#8d9e82"; # colour5 / primary1
      mark3_foreground          = "#131714"; # background0
