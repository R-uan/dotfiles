{
  ...
  programs.kitty = {
    ...
    settings = {
      ...
      cursor_text_color = "#171c1a"; # background0
      ...
      wayland_titlebar_color = "#171c1a"; # background0
      macos_titlebar_color = "#1c231e"; # background1

      active_tab_foreground = "#171c1a"; # background0
      ...
      tab_bar_background = "#171c1a"; # background0

      mark1_foreground = "#171c1a"; # background0
      mark1_background = "#83977f"; # colour4 / primary0
      mark2_foreground = "#171c1a"; # background0
      mark2_background = "#8d9e82"; # colour5 / primary1
      mark3_foreground = "#171c1a"; # background0
